            ...
            <el-row>
              <el-col :span="3" id="colleft" style="overflow-x:hidden;overflow-y:auto" v-bind:style="{height:contain.Height-40+'px',backgroundColor:'#eee'}">
                <el-container style="height: 100%;border-right: 1px solid #eee;">
                  ...
                  <el-main>
                  <ul>
                    <ml-tree v-show="show.zujian" v-for="(item,index) in module" :key="index" datatype="drag" :module="item" MenuType="zujian"></ml-tree>
                    <ml-tree v-show="show.shiyan" v-for="(item,index) in document" :key="index" datatype="common" :module="item" MenuType="shiyan" :now="now"></ml-tree>
                    <ml-tree v-show="show.shuju" v-for="(item,index) in DataSource" :key="index" datatype="drag" :module="item" MenuType="shuju"></ml-tree>
          ...
          <el-row>
            <el-col :span="12">
              ...
              <el-form ref="form" :model="setform" label-width="80px">
                  ...
                  <ml-item :label="webApp.jianjie.title" :labelStyle="'font-size: 16px;font-weight: 700;width: 100%;'"><label v-for="(v,index) in webApp.jianjie.value" :keys="index"> {{ v }} </label></ml-item>
                  <ml-item :label="webApp.banben.title" :labelStyle="'font-size: 16px;font-weight: 700;width: 100%;'"><label v-for="(v,index) in webApp.banben.value" :keys="index"> {{ v }} </label></ml-item>
                  </ml-item>
              </el-form>
            </el-col>
          </el-row>
      ...
      <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
        ...
        <el-form-item label="位置" prop="address">
          <el-radio-group v-model="ruleForm.address">
            <div class="ml-select">
              <ul style="margin: 5px 0;"><ml-select-dir v-for="(item,index) in selectdir" :key="index" :selectdir="item"></ml-select-dir></ul>
            </div>
          </el-radio-group>
        </el-form-item>
        <el-form-item>
